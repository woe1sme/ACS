...
namespace Wallet.Api.Infrastructure.Migrations
{
    ...
    [Migration("20260924091909_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wallet.Api.Domain.WalletEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CommissionId")
                        .IsUnique()
                        .HasDatabaseName("ix_wallet_entries_commission_id");

                    b.HasIndex("CreatedAt", "Id")
                        .HasDatabaseName("ix_wallet_entries_pending")
                        .HasFilter("status = 'Pending'");

                    b.HasIndex("UserExternalId", "PaidAt", "Id")
                        .IsDescending(false, true, false)
                        .HasDatabaseName("ix_wallet_entries_paid_by_user")
                        .HasFilter("status = 'Paid'");

                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("UserExternalId", "PaidAt", "Id"), new[] { "Amount" });

                    b.ToTable("wallet_entries", null, t =>
                        {
