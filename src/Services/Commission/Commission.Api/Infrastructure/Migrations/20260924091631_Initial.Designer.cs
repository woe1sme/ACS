...
namespace Commission.Api.Infrastructure.Migrations
{
    ...
    [Migration("20260924091631_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Commission.Api.Domain.CommissionRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("BeneficiaryExternalId")
                        ...
                        .HasColumnName("beneficiary_external_id");
                    ...
                    b.Property<string>("EventExternalId")
                        ...
                        .HasColumnName("event_external_id");
                    ...
                    b.HasIndex("EventExternalId", "BeneficiaryExternalId")
                        .IsUnique()
                        .HasDatabaseName("ix_commissions_event_external_id_beneficiary_external_id");
            ...
            modelBuilder.Entity("Commission.Api.Domain.SchemeSettings", b =>
                {
                    b.Property<short>("Id")
                        .HasColumnType("smallint")
                        .HasColumnName("id");

                    b.Property<string>("ActiveSchemeType")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasColumnName("active_scheme_type");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_commission_scheme_settings");

                    b.ToTable("commission_scheme_settings", null, t =>
                        {
                            t.HasCheckConstraint("ck_scheme_settings_singleton", "id = 1");
                        });
